...
// // export const YOUTUBE_VIDEOS_API = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=50&myRating=like&regionCode=IN&key=${API_KEY}`;
...
// named export 
export const API_KEY = "AIzaSyAVGsZRlwb1xsOtwbDD7WMajpLQ1saEYA0";
export const BASE_URL = "https://www.googleapis.com/youtube/v3"
